      ...
      {showSidebar ? (
        <div className={style.sidebarMainContainer}>
          <div className={`${style.sidebarBody}${style.appendClass}`}>
            <div className={style.sidebarHeader}>
              <div className={style.sideBarHeaderLink}>
                ...
                <img
                  ...
                  className={`${
                    lng === 'en'
                      ? style.sidebarHeaderFlagOff
                      : style.sidebarHeaderFlag
                  }`}
                  src="/spain.svg"
                  alt="Spain flag"
                  width={20}
            ...
            <h3 className={style.sidebarH3}>
              {t(`sidebar.slogan`)}{' '}
              <span className={style.sidebarH3span}>
                {t(`sidebar.sloganSpan`)}
              </span>
            </h3>
        ...
        <div
          className={`${style.sidebarBodyHidden}`}
