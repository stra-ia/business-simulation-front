...
export default function BriefResume() {
  ...
  const resume: briefResume = {
    ...
    scenery:
      'Eres el especialista en marketing digital de "Artesanía Creativa", una pequeña empresa que vende productos artesanales hechos a mano a través de su sitio web',
    challenge:
      'Artesanía Creativa tiene una presencia limitada en línea. Si bien cuentan con un sitio web funcional y atractivo, su alcance en redes sociales es mínimo y no han invertido',
    campaign: {
      strategy:
        'Diseñar una campaña de anuncios en Facebook dirigida a usuarios interesados en productos artesanales',
      tactics:
        'Utilizar imágenes llamativas de los productos, mensajes que resalten la calidad',
      consequences:
        'Aumento significativo del tráfico web, mayor conocimiento de marca, potencial para generar leads y conversiones'
    }
  }
